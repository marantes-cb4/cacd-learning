...
> **Como usar este guia:** Apenas cursos e professores especializados em CACD. Preços são estimativas — verifique nos sites antes de contratar.

---

## Seu Diagnóstico (TPS 2026 — Fase 1)

| Matéria | Score | % | Prioridade |
|---------|-------|---|------------|
| Direito | 4.0 | 33% | 🔴 Máxima — curso estruturado |
| Economia | 11.5 | 58% | 🔴 Máxima — curso estruturado |
| História do Brasil | 8.5 | 46% | 🟠 Intermediária — revisão de conteúdo |
| Língua Inglesa | 17.5 | 67% | 🟡 Moderada — leitura extensiva |
| História Mundial | 13.25 | 68% | 🟡 Moderada — revisão temática |
| Política Internacional | 24.25 | 71% | 🟡 Moderada — conjuntura + questões |
| Geografia | 15.25 | 71% | 🟡 Moderada — revisão + questões |
| Língua Portuguesa | 30.5 | 84% | 🟢 Manutenção |

---

## Matriz de Decisão — Melhores Opções por Matéria
...
## 1. DIREITO 🔴 PRIORIDADE MÁXIMA (33%)
...
- **CIJ** (icj-cij.org): casos e pareceres consultivos — leitura obrigatória
...
## 2. ECONOMIA 🔴 PRIORIDADE MÁXIMA (58%)
...
| 3 | **Michelle Miltons** | Reddit | Presente na comunidade — pesquisar avaliações antes de contratar |
| 4 | **Armstrong** | Reddit | Idem — verificar avaliações detalhadas |

### Recursos Gratuitos
- **Podcast "Café com Macro"** (XP/Itaú): análise macroeconômica aplicada
- **IPEA** (ipea.gov.br): Boletim de Conjuntura, textos para discussão — gratuitos e indispensáveis
- **Banco Central do Brasil**: Relatório de Inflação, Notas de Política Monetária
- **Project Syndicate** (projectsyndicate.org): artigos de economistas de alto nível

### Leituras obrigatórias
- Celso Furtado — *Formação Econômica do Brasil* (unanimidade entre aprovados)
- Blanchard — *Macroeconomia* (capítulos IS-LM, Mundell-Fleming)
- Krugman & Obstfeld — *Economia Internacional*

### O que aprovados dizem
**Celso Furtado é leitura indispensável.** Resolver as provas antigas de Economia da Fase 2 é o método principal — a banca tem padrões muito identificáveis.

---

## 3. HISTÓRIA DO BRASIL 🟠 PRIORIDADE INTERMEDIÁRIA (46%)
...
| # | Professor | Fonte | Observações |
|---|-----------|-------|-------------|
| 1 | **Luigi Bonafé** | Reddit + sites especializados | "Vale MUUUITO a pena, apesar de ser super cansativo" — consenso no Reddit |
| 2 | **Rodrigo Goyena** | Reddit + reviews | Bem avaliado pela comunidade |
| 3 | **João Daniel** | Reddit + Nabuco | Mencionado com frequência |

### Recursos Gratuitos
- **CPDOC/FGV** (cpdoc.fgv.br): acervo digitalizado, verbetes, entrevistas — indispensável para PEB e história republicana
- **Cadernos de Política Exterior** (IPRI/FUNAG): para PEB — download PDF gratuito
...
### O que aprovados dizem
**Não use só material de concurseiro para HB.** A banca cobra análise historiográfica — é preciso saber quem são os autores e o que defendem. CPDOC é recurso obrigatório.
...
- **Foreign Affairs** (foreignaffairs.com): política internacional em inglês
- **Project Syndicate** (projectsyndicate.org): economistas e analistas; gratuito com cadastro
- **Provas antigas do CACD**: o melhor banco de questões disponível

### O que aprovados dizem
Consenso: **leitura extensiva diária supera qualquer curso**. Candidatos com nível adequado não fazem curso específico de inglês.
...
### Recursos Gratuitos
- **Podcast "Xadrez Verbal"** ⭐: recurso gratuito mais citado por aprovados; análise geopolítica com profundidade analítica; desenvolve vocabulário geopolítico
- **FUNAG** (funag.gov.br): *Cadernos de Política Exterior* — download PDF gratuito; produzido dentro do Itamaraty
- **IPRI** (ipri.itamaraty.gov.br): publicações do Instituto de Pesquisa de Relações Internacionais
- **Foreign Affairs**, **CFR** (cfr.org): análises de alto nível
...
### Leituras obrigatórias
- Eric Hobsbawm — *Era das Revoluções*, *Era do Capital*, *Era dos Impérios*, *Era dos Extremos* ⭐ (todos os quatro — unanimidade entre aprovados)
...
### O que o CACD cobra
Geopolítica, geografia econômica, recursos naturais, questões ambientais, fronteiras, geografia física. Forte interseção com PI.

### Professores CACD-Especializados
...
- **Documentários DW / National Geographic**: recursos naturais, fronteiras, clima
...
### O que o CACD cobra
Fase 1: compreensão de textos complexos + gramática contextual. Fase 2: dissertativa — argumentação, coesão, precisão vocabular, estilo formal.
...
### O que aprovados dizem
Para Fase 2: **só melhora quem escreve muito e recebe feedback qualificado**. Com 84% na Fase 1, LP pode ser sustentada com leitura regular.
...
- **Instituto Cervantes — CVC** (cvc.cervantes.es): gramática e exercícios — gratuito

### O que aprovados dizem
**Escreva muito, receba correção.** El País diário + dissertações sobre temas de provas antigas + feedback qualificado é a fórmula citada.
...
| Ano | Onde encontrar |
|-----|---------------|
| TPS 2026 | Já na pasta `Simulados/` deste repositório |
| TPS 2025 e anteriores | Itamaraty.gov.br → Concursos → CACD → Provas Anteriores |
| Fase 2 (dissertações) | Mesmo caminho; procurar por "Cadernos Fase 2" |
...
- **Provas antigas do CACD** (todas as matérias)
