...
| 3 | Constituição: conceito, classificações, primado da Constituição, controle de constitucionalidade | ✅ Completo | Conceito e Classificação da Constituição.md, Controle de Constitucionalidade.md, Controle de Constitucionalidade - Parte 2.md | Parte 2 acrescenta o momento de realização do controle (preventivo x repressivo), atuação dos 3 Poderes no preventivo, mudança jurisprudencial STF 2025 sobre autotutela do Executivo e distinção de efeitos entre controle difuso e concentrado |
