# Conteúdo Programático — CACD 2027
### Fonte: Edital CACD 2026, Anexo III

> Todos os tópicos abaixo são extraídos literalmente do edital oficial. O que cai na **Fase 1** (objetiva) e na **Fase 2** (dissertativa) está indicado por matéria.
...
### 1.1 Língua Portuguesa: modalidade culta contemporânea no Brasil
- Sistema gráfico: ortografia, acentuação, pontuação, legibilidade
- Morfossintaxe
- Semântica
- Vocabulário

### 1.2 Leitura e produção de textos
- Compreensão, interpretação e análise crítica de textos
- Linguística, literatura e estilística:
  - Funções da linguagem
  - Níveis e variação linguística
  - Gêneros e estilos textuais
  - Textos literários e não literários
  - Denotação e conotação
  - Figuras de linguagem
  - Estrutura textual
- Redação dissertativa: fundamentação conceitual e factual, argumentação, progressão temática, coerência, objetividade, precisão, clareza, concisão, coesão, correção gramatical
  - Defeitos de conteúdo: descontextualização, generalização, simplismo, obviedade, paráfrase, cópia, tautologia, contradição
  - Vícios de linguagem: ruptura de registro, coloquialismo, barbarismo, anacronismo, rebuscamento, redundância, linguagem estereotipada

---

## 2. LÍNGUA INGLESA
**Fase 1:** compreensão leitora
**Fase 2:** produção escrita

### Fase 1
- Compreensão de textos escritos em inglês
- Itens gramaticais relevantes para a compreensão semântica

### Fase 2
- Redação em inglês: expressão avançada, gramática, qualidade e propriedade da linguagem, organização e desenvolvimento de ideias
- Versão de texto do português para o inglês: fidelidade ao texto-fonte, respeito ao registro, correção morfossintática e lexical
...
- União Europeia: origens, evolução, estrutura, funcionamento, situação atual, política externa, relações com o Brasil
...
- Direitos humanos e políticas de identidade: gênero, raça e religião como vetores da política mundial
- Migrações internacionais, migrantes, refugiados e apátridas
- Comércio internacional, OMC e cadeias globais de suprimento
- Sistema financeiro internacional
- Desarmamento e não proliferação
- Crimes de guerra e crimes contra a humanidade: genocídio, holocausto, Tribunal Penal Internacional
- Terrorismo
...
#### 1.1 Demanda do Consumidor — ✅ coberto totalmente
- Preferências
...
#### 2.1 Contabilidade Nacional — ✅ coberto totalmente
- Conceitos de renda e produto
...
- Conceitos de superávit e déficit público
- Abordagem Ricardiana da Dívida Pública
- Endividamento e responsabilidade fiscal
- Papel do governo; objetivos e instrumentos de política fiscal
...
- Objetivos e instrumentos de política monetária
...
#### 3.1 Teorias de Comércio — ✅ coberto totalmente
- Teorias clássicas, neoclássicas e contemporâneas do comércio internacional
- Comércio intrafirma e intrasetorial
...
#### 4.1–4.2 Século XIX e Primeira República — ✅ coberto totalmente
- Economia cafeeira
- Políticas econômicas e evolução da economia
...
## 9. ESPANHOL (Fase 2 — idioma adicional)

- Elaboração de resumo em espanhol a partir de texto em espanhol (capacidade de síntese e reelaboração em registro culto)
- Versão de texto do português para o espanhol (fidelidade ao texto-fonte, registro, correção morfossintática e lexical)

---

## Resumo por prioridade (Fase 1 — itens)

| Matéria | Itens Fase 1 | Peso | Observação |
|---------|-------------|------|------------|
| LP | ~40 | alto | Manutenção — 84% |
| PI | ~38 | alto | Moderada — 71% |
| HB | ~26 | alto | Intermediária — 46% |
| Inglês | ~30 | médio | Moderada — 67% |
| HM | ~22 | médio | Moderada — 68% |
| Geo | ~24 | médio | Moderada — 71% |
| Eco | ~24 | máximo | Máxima — 58% |
| Direito | ~24 | máximo | Máxima — 33% |

> **Nota:** HM é cobrada **apenas** na Fase 1. Espanhol é cobrado **apenas** na Fase 2.

---

> **Fonte:** Edital CACD 2026, Anexo III — Objetos de Avaliação (publicado em 28/01/2026)
> Arquivo original: `Editais/Edital CACD 2026.pdf`
